...
touch $ERROR_FILE
touch $OUTPUT_FILE && echo "Algorithm;Cores;Tile_size;N_train;N_test;N_regressor;Total_time;Assemble_time;Cholesky_time;Triangular_time;Predict_time;Error;${N_LOOP}" >> $OUTPUT_FILE
