...
class Hpx(CMakePackage, CudaPackage, ROCmPackage):
    ...
    def cmake_args(self):
        ...
        # Custom CMake options to install properly on simcl1n1 or simcl1n2.
        # - uses Clang as CUDA compiler
        # - uses CUDA Compute Capability 8.0 for NVIDIA A30
        # - allow HPX CMake files to download APEX
        args.append("-DNVCC_WRAPPER_DEFAULT_COMPILER=clang")
        args.append("-DCMAKE_CUDA_COMPILER=clang")
        args.append("-DCMAKE_CUDA_ARCHITECTURES=61")
