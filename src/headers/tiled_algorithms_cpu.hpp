...
template <typename T>
void forward_solve_tiled(std::vector<hpx::shared_future<host_buffer_t<T>>> &ft_tiles,
...
template <typename T>
void backward_solve_tiled(std::vector<hpx::shared_future<host_buffer_t<T>>> &ft_tiles,
                          std::vector<hpx::shared_future<std::vector<T>>> &ft_rhs,
                          std::size_t N,
                          std::size_t n_tiles)
{
