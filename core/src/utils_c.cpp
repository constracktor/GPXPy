...
int compute_train_tiles(int n_samples, int n_tile_size)
{
    ...
    else
    {
        throw std::runtime_error(
            "Error: Please specify a valid value for train_tile_size.\n");
    }
}
...
int compute_train_tile_size(int n_samples, int n_tiles)
{
    ...
    {
        throw std::runtime_error(
            "Error: Please specify a valid value for train_tiles.\n");
    }
}
 ...
 */
std::pair<int, int>
compute_test_tiles(int n_test, int n_tiles, int n_tile_size)
{
...
std::vector<double> load_data(const std::string &file_path, int n_samples)
{
    ...
    {
        scanned_elements +=
            fscanf(input_file, "%lf", &_data[i]);  // scanned_elements++;
    }
    ...
    {
        throw std::runtime_error(
            "Error: Data not correctly read. Expected " + std::to_string(n_samples) + " elements, but read " + std::to_string(scanned_elements));
    }
