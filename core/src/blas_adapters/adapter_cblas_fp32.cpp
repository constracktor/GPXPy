#include "../include/blas_adapters/adapter_cblas_fp32.hpp"
                             ...
                             const BLAS_TRANSPOSE transpose_B)
{
  ...
  const float beta = 1.0;
  // GEMM: C = C - A(^T) * B(^T)
  cblas_sgemm(CblasRowMajor, static_cast<CBLAS_TRANSPOSE>(transpose_A), static_cast<CBLAS_TRANSPOSE>(transpose_B),
                               ...
                               const BLAS_TRANSPOSE transpose_L)
{
  ...
  cblas_strsv(CblasRowMajor, CblasLower, static_cast<CBLAS_TRANSPOSE>(transpose_L), CblasNonUnit,
              N, L.data(), N, a.data(), 1);
                               ...
                               const BLAS_TRANSPOSE transpose_A)
{
  ...
  cblas_sgemv(CblasRowMajor, static_cast<CBLAS_TRANSPOSE>(transpose_A), N, M, alpha,
